...
<a href=credimut.php><input class="INFO_CREDIMUT"
	...
	La société générale est une des banques les plus anciennes de France. C'est la banque qui vous conseille depuis 156 ans!</br>
	<a href=https://particuliers.societegenerale.fr>Site du groupe</a>

<a href=sogenal.php><input class="INFO_SOGENAL"
       type="button"
       value="Lire la suite"></a></article>
